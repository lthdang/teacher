...
This service provides the core business logic and API layer for the Teacher system. It supports:
...
├── TeacherApplication.java             # Application entry point
...
cd Teacher_Management/Sources/BE/teacher
```
